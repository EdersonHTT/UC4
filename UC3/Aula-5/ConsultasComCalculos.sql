...
SELECT SUM(valorTotal) AS valor_soma_total-- esse AS é basicamente a legenda que vai aparecer
FROM tabela;

-- Faz a média todos os valore de uma determinada coluna
SELECT AVG(valorTotal) AS valor_soma_total-- esse AS é basicamente a legenda que vai aparecer
FROM tabela;
...
-- Da o menor vaor de uma determinada coluna
SELECT MAX(valorTotal) AS valor_soma_total-- esse AS é basicamente a legenda que vai aparecer
FROM tabela;